# Review Draft: MCP / AI-agent repo READMEs must document all 5 clients (Claude Desktop, Claude Code, OpenClaw, Hermes Agent, Codex CLI)

- Generated: 2026-04-20 22:09 UTC
- Source handoff: `.claude/memory-handoffs/2026-04-20-mcp-readme-five-client-rule.md`
- Type: `preference`
- Recommended action: `create-card`
- Target card: `mcp-readme-five-client-rule.md`
...
## Reviewer notes
- Decide final destination: memory card, TOOLS.md, USER.md, rules, learnings, or archive only.
- Update an existing card when possible before creating a new one.
- If this is not durable enough, archive it and do not promote it.
